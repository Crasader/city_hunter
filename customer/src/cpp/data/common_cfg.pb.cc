...
void protobuf_AssignDesc_common_5fcfg_2eproto() {
  protobuf_AddDesc_common_5fcfg_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_common_5fcfg_2eproto);
}
...
void protobuf_AddDesc_common_5fcfg_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\020common_cfg.proto\022\tgamer.cfg\"\'\n\004Vec3\022\t\n"
    "\001x\030\001 \002(\002\022\t\n\001y\030\002 \002(\002\022\t\n\001z\030\003 \002(\002", 70);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "common_cfg.proto", &protobuf_RegisterTypes);
  Vec3::default_instance_ = new Vec3();
  Vec3::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_common_5fcfg_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_common_5fcfg_2eproto {
  StaticDescriptorInitializer_common_5fcfg_2eproto() {
    protobuf_AddDesc_common_5fcfg_2eproto();
  }
} static_descriptor_initializer_common_5fcfg_2eproto_;
...
Vec3::Vec3()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:gamer.cfg.Vec3)
}
...
Vec3::Vec3(const Vec3& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:gamer.cfg.Vec3)
}
...
Vec3::~Vec3() {
  // @@protoc_insertion_point(destructor:gamer.cfg.Vec3)
  SharedDtor();
}
...
const Vec3& Vec3::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_common_5fcfg_2eproto();
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gamer.cfg.Vec3)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gamer.cfg.Vec3)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gamer.cfg.Vec3)
  return false;
#undef DO_
}
...
void Vec3::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gamer.cfg.Vec3)
  // required float x = 1;
  if (has_x()) {
  ...
  // @@protoc_insertion_point(serialize_end:gamer.cfg.Vec3)
}

::google::protobuf::uint8* Vec3::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:gamer.cfg.Vec3)
  // required float x = 1;
  if (has_x()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:gamer.cfg.Vec3)
  return target;
}
